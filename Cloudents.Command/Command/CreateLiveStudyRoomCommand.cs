...
namespace Cloudents.Command.Command
{
    public class CreateLiveStudyRoomCommand : ICommand
    {
        public CreateLiveStudyRoomCommand(long tutorId, 
            string name, decimal price, DateTime broadcastTime,  string? description, StudyRoomRepeat? repeat, DateTime? endDate, int? endAfterOccurrences, IEnumerable<DayOfWeek> repeatOn)
        {
            TutorId = tutorId;
            Name = name;
            Price = price;
