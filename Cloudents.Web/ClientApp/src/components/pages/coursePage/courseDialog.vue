<template>
  <v-dialog :value="true" content-class="coursePayment" :fullscreen="$vuetify.breakpoint.xsOnly" persistent max-width="500px" transition="dialog-transition" scrollable>
    <div class="text-center">
        ...
        <div class="coursePaymentActions mb-4">
            <v-btn class="coursePaymentBtnConnect white--text" tag="a" target="_blank" href="https://spitball.payme.co.il/onboarding/5d4c0b6d0aee19001ceec9bb" width="150" height="40" depressed rounded color="#4452fc">
...
.coursePayment {
    ...
    .coursePaymentActions {
      margin-top: 150px;

      .coursePaymentBtnConnect {
        font-weight: 600;
      }
      .coursePaymentBtnBack {
          margin: 6px 8px;
          color: @global-blue;
          font-weight: 600;
