    ...
    <router-link class="tutor-result-card-desktop pa-4" @click.native.prevent="tutorCardClicked" :to="{name: 'profile', params: {id: tutorData.userId, name:tutorData.name}}">
        ...
        <div class="user-rates">
            ...
            <div class="classes-hours align-center">
              ...
              <template>
                <span class="font-weight-bold no-classes" v-t="'resultTutor_no_hours_completed'" v-if="tutorData.lessons === 0"></span>
                <span class="font-weight-bold no-classes" v-t="tutorData.lessons === 1 ? 'resultTutor_hour_completed' : 'resultTutor_hours_completed' " v-else></span>    
              </template>
            </div>                
