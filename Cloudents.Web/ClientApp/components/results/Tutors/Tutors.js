...
export default {
    ...
    methods: {
        ...
        ...mapGetters(["Tutors_getNextPageUrl", "getResultLockForSchoolNameChange", "getResultLockForClassesChange"]),
        goToAskQuestion() {
        ...
        scrollFunc() {
            ...
            let nextPageUrl = this.Tutors_getNextPageUrl();
            if (this.name !== this.pageData.vertical) return;
            this.Tutors_nextPage({vertical: this.pageData.vertical, url: nextPageUrl})
                .then((res) => {
        ...
        updateContentOfPage(to, from, next) {
            ...
            this.Tutors_fetchingData({name: toName, params}, true)
                .then((data) => {
