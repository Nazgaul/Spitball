...
export let documentTypes = [
    LanguageService.getValueByKey("upload_files_type_lecture"),
    LanguageService.getValueByKey("upload_files_type_textbook"),
    LanguageService.getValueByKey("upload_files_type_exam"),
    LanguageService.getValueByKey("upload_files_type_default")
    // {
    //     // id: 'lecture',
