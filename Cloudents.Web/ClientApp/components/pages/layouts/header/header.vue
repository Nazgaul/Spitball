        ...
        <div class="globalHeader_items">
            ...
            <div class="globalHeader_items_right">
                ...
                <template v-if="!$vuetify.breakpoint.smAndDown && !loggedIn">
                    <button class="gH_i_r_btns gH_i_r_btn_in me-2" @click="$store.commit('setComponent', 'login')" v-language:inner="'tutorListLanding_topnav_btn_login'"/>
                    <button class="gH_i_r_btns gH_i_r_btn_up me-4" @click="$store.commit('setComponent', 'registerType')" v-language:inner="'tutorListLanding_topnav_btn_signup'"/>
