        ...
        <div class="globalHeader_items">
            ...
            <div class="globalHeader_items_right">
                ...
                <template v-if="!$vuetify.breakpoint.smAndDown && !loggedIn">
                    <button class="gH_i_r_btns gH_i_r_btn_in mr-2" @click="$router.push('/login')" v-language:inner="'tutorListLanding_topnav_btn_login'"/>
                    <button class="gH_i_r_btns gH_i_r_btn_up mr-4" @click="$router.push('/register')" v-language:inner="'tutorListLanding_topnav_btn_signup'"/>
