<template>
   <v-flex xs12 sm6 md3 class="teacherInfoContainer">
      <div class="teacherInfoHeader pl-4 d-flex flex-grow-0 flex-shrink-0 align-center ">
         <v-icon @click="$emit('toggleTeacherInfo')" class="mr-3 d-flex d-md-none" size="16" :color="isMobile? '#ffffff' : '#69687d'">{{isRtl?'sbf-arrow-right-carousel':'sbf-arrow-left-carousel'}}</v-icon>
