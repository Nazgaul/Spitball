<template>
    ...
    <div class="term">
        ...
        <p>If your contact information, or other information related to your account, changes, you must notify us promptly and keep your information current. The Services are not intended for use by you if you are under 13 years of age. By agreeing to these Terms, you are representing to us that you are over 13.</p>
        <h2>Account Security</h2>
        <p>You are responsible for safeguarding the password that you use to access the Services and you agree not to disclose your password to any third party. You are responsible for any activity using your account, whether or not you authorized that activity. You should immediately notify Spitball of any unauthorized use of your account. You acknowledge that if you wish to protect your transmission of data or files to Spitball, it is your responsibility to use a secure encrypted connection to communicate with the Services.</p>
        <h2>Software and Updates</h2>
        <p>Some use of our Service requires you to download a client software package. Spitball hereby grants you a limited, nonexclusive, nontransferable, revocable license to use the Software, solely to access the Services. Your license to use the Software is automatically revoked if you violate these Terms in a manner that implicates our intellectual property rights. We hereby reserve all rights not expressly granted in these Terms. You must not reverse engineer or decompile the Software, nor attempt to do so, nor assist anyone else to do so. Our Services may update the Software on your device automatically when a new version is available. Our pause syncing feature pauses syncing of your files, but may not cease all data transfer, so you should exit the desktop client if you'd like to stop data transfer.</p>
        <h2>Spitball Property and Feedback</h2>
        <p>These terms do not grant you any right, title, or interest in the Services, Software, or the content in the Services. While we appreciate it when users send us feedback, please be aware that we may use any feedback, comments, or suggestions you send us or post in our forums without any obligation to you. The Software and other technology we use to provide the Services are protected by copyright, trademark, and other laws of both the United States and foreign countries. These Terms do not grant you any rights to use the Spitball trademarks, logos, domain names, or other brand features.</p>
        <h2>Acceptable Use Policy</h2>
        <p>You will not, and will not attempt to, misuse the Services, and will use the Services only in a manner consistent with the Spitball Acceptable Use Policy.</p>
        <h2>Objectionable Content Policy</h2>
        <p>Content may be submitted to Spitball, who will moderate all content and ultimately decide whether or not to post a submission or remove a post submitted to the extent such content includes, is in conjunction with, or alongside any, Objectionable Content. Objectionable Content includes, but is not limited to: (i) sexually explicit materials; (ii) obscene, defamatory, libelous, slanderous, violent and/or unlawful content or profanity; (iii) content that infringes upon the rights of any third party, including copyright, trademark, privacy, publicity or other personal or proprietary right, or that is deceptive or fraudulent; (iv) content that promotes the use or sale of illegal or regulated substances, tobacco products, ammunition and/or firearms; and (v) gambling, including without limitation, any online casino, sports books, bingo or poker.</p>
        <h2>Other Sites</h2>
        <p>The Services may contain links to third-party websites or resources. Spitball does not endorse and is not responsible or liable for their availability, accuracy, the related content, products, or services. You are solely responsible for your use of any such websites or resources. Other sites may provide features that allow you to share your stuff with others or to make it public. There are many things that users may do with that stuff (for example, copy it, modify it, re-share it). Please consider carefully what you choose to share or make public. Spitball has no responsibility for that activity. Also, if we provide you with any software under an open source license, there may be provisions in those licenses that expressly conflict with these Terms, in which case the open source provisions will apply.</p>
        <h2>Termination</h2>
        ...
        <h2>Spitball Acceptable Use Terms and Use Policy</h2>
        <p>Spitball takes privacy very seriously and we are constantly improving our services to better serve our customers.</p>
        <p>You agree not to misuse the Spitball services. For example, you must not, and must not attempt to, use the services to do the following things.</p>
        <ul>
            ...
            <li>access, tamper with, or use non-public areas of the Service, shared areas of the Service you have not been invited to, Spitball (or our service providers') computer systems;</li>
            ...
            <li>abuse Spitball referrals to get more credit for referrals than deserved;</li>
        ...
        <h2>Copyright</h2>
        <p>Spitball respects others' intellectual property and asks that you do too. We will respond to notices of alleged copyright infringement if they comply with the law and are properly provided to us. Such notices should be reported using our DMCA Process. We reserve the right to delete or disable content alleged to be infringing and to terminate repeat infringers. Our designated agent for notice of alleged copyright infringement on the Services is provided at the end of this document:</p>
        <h2>Spitball DMCA Policy</h2>
        <p>Spitball ("Spitball") respects the intellectual property rights of others and expects its users to do the same. In accordance with the Digital Millennium Copyright Act of 1998, the text of which may be found on the U.S. Copyright Office website at <a target="_blank" href="http://www.copyright.gov/legislation/dmca.pdf">http://www.copyright.gov/legislation/dmca.pdf</a>, Spitball will respond expeditiously to claims of copyright infringement committed using the Spitball service and/or the Spitball website (the "Site") if such claims are reported to Spitball's Designated Copyright Agent identified in the sample notice below.</p>
        ...
        <center>DMCA Notice of Alleged Infringement (<i><b>"Notice"</b></i>)</center>
        <ol>
        ...
        <p>Deliver this Notice, with all items completed, to Spitball's Designated Copyright Agent:</p>
        <h2>The Spitball “Refer a friend” terms and conditions </h2>
        <p>
            These terms and conditions (“Terms”) apply to Spitball’s Refer a Friend program (“Program”). By referring a friend, acting on a referral, using the Program, or otherwise participating in the Program, the referring customer and/or referred friend agree to be bound by these Terms.
            <br><br>
            1. The individual who was issued a Link by Spitball will be considered to be the "Referring Customer" for all Qualified Referrals made using that Spitball Link.
            <br><br>
            2. Please note the referral programs are only applicable to some operators/countries.
            <br><br>
            3. To cash out a referral bonus, the Referring Customer must refer a Qualified Referred Friend.
            <br><br>
            4. To be considered a Qualified Referred Friend, the Referred Friend has to be a real user.
            <br><br>
            5. Referring Customers will receive a reward associated with the Program they are eligible for, each time a Qualified Referred Friend uses the referral link associated to their account. You will not receive a reward if your referrals are considered Fraud for any reason, (including, if the Referred Friend does not satisfy the requirements to be considered a Qualified Friend) or are not received for any reason.
            <br><br>
            6. Rewards are automatically applied to the Referring Customer’s account and we will notify the Referring Customer by email when rewards have been transferred within 48 hours.
            <br><br>
            7. A Referring Customer should not send referrals to people that you do not personally know, and you should honour all requests to stop referrals or communications about the Program.
            <br><br>
            8. A Referring Customer should not engage in any misleading, deceptive, annoying, or harassing practices with respect to referrals or Program communications.
            <br><br>
            9. A Qualified Referred Friend will receive a reward associated with the program they are eligible for. A Referred Friend is only entitled to receive one (1) reward as a Referred Friend.
            <br><br>
            10. Offer not valid and rewards are not payable for self-referrals and fraudulent transactions. We reserve the right to stop any customer from using our services who we believe is using a referral campaign in an unethical manner.
            <br><br>
            11. Spam and the use of Purchased or harvested lists is prohibited and will result in immediate termination of the Referring Customers account and deactivation of RAF Links.
            <br><br>
            12. Spitball reserves the right to cancel, alter, amend, suspend, withdraw or terminate the Refer-a-Friend Program or to change these terms and conditions at any time in its sole discretion.
            <br><br>
        ...
        <p>
            Copyright Agent<br />
            Cloudents LTD.<br />
            Hanasi Harishon, 38<br />
            Rehovot, Israel<br />
            <a href="mailto:support@spitball.co">support@spitball.co</a>
        </p>
    </div>
</template>
<script>
