<template functional v-once>
    <div class="term">
        ...
        <br />
        <br />
        By using our Services you provide us with information, folders, and files that you submit to Spitball (together, "your stuff"). You retain full ownership to your stuff. We don't claim any ownership to any of it. These Terms do not grant us any rights to your stuff or intellectual property except for the limited rights that are needed to run the Services, as explained below.
        ...
        To be clear, aside from the rare exceptions we identify in our Privacy Policy, no matter how the Services change, we won't share your content with others, including law enforcement, for any purpose unless you direct us to. How we gather and use your information generally is also explained in our Privacy Policy.
        ...
        Files and other content in the Services may be protected by intellectual property rights of others. Please do not copy, upload, download, or share files unless you have the right to do so. You, not Spitball, will be fully responsible and liable for what you copy, share, upload, download or otherwise use while using the Services. You must not upload spyware or any other malicious software to the Service.
        You, and not Spitball, are responsible for maintaining and protecting all of your stuff. Spitball will not be liable for any loss or corruption of your stuff, or for any costs or expenses associated with backing up or restoring any of your stuff.
        ...
        <br />
        Account Security
        You are responsible for safeguarding the password that you use to access the Services and you agree not to disclose your password to any third party. You are responsible for any activity using your account, whether or not you authorized that activity. You should immediately notify Spitball of any unauthorized use of your account. You acknowledge that if you wish to protect your transmission of data or files to Spitball, it is your responsibility to use a secure encrypted connection to communicate with the Services.
        <br />
        <br />
        Software and Updates
        Some use of our Service requires you to download a client software package. Spitball hereby grants you a limited, nonexclusive, nontransferable, revocable license to use the Software, solely to access the Services. Your license to use the Software is automatically revoked if you violate these Terms in a manner that implicates our intellectual property rights. We hereby reserve all rights not expressly granted in these Terms. You must not reverse engineer or decompile the Software, nor attempt to do so, nor assist anyone else to do so. Our Services may update the Software on your device automatically when a new version is available. Our pause syncing feature pauses syncing of your files, but may not cease all data transfer, so you should exit the desktop client if you'd like to stop data transfer.
        <br />
        <br />
        Spitball Property and Feedback
        ...
        <br />
        <br />
        Spitball Acceptable Use Terms and Use Policy
        Spitball takes privacy very seriously and we are constantly improving our services to better serve our customers.
        You agree not to misuse the Spitball services. For example, you must not, and must not attempt to, use the services to do the following things.
        probe, scan, or test the vulnerability of any system or network;
        breach or otherwise circumvent any security or authentication measures;
        access, tamper with, or use non-public areas of the Service, shared areas of the Service you have not been invited to, Spitball (or our service providers') computer systems;
        ...
        Deliver this Notice, with all items completed, to Spitball's Designated Copyright Agent:
        <br />
        <br />
        Copyright Agent<br />
        Cloudents LTD.<br />
