<template>
    ...
    <div class="term">
        ...
        <p class="modified-date">Last Modified 1/1/2018</p>
        <p>This Privacy Policy provides our company policies and procedures for gathering, using, and disclosing your information. Users can access the Spitball service through our website, located at <a target="_blank" href="https://www.spitball.co">www.spitball.co</a>, applications on Devices, and through third-parties. A "Device" is defined as any computer used to access the Spitball Service, including without limitation a desktop, laptop, mobile phone, tablet, web enabled TV, or other consumer electronic device. This Privacy Policy governs your access of the Spitball Service, regardless of how you access it, and by using our Services you agree to the gathering, transfer, processing, storage, disclosure and other uses described in this Privacy Policy. All of the various forms of data, content, and information described below are referred to as "information."</p>
        <p>At Spitball we take security and privacy very seriously. Your personal information is actively protected by us. Communications with our web and mobile services are encrypted using industry standard AES encryption, we use European data centres and your passwords are stored using non-reversible encryption.</p>
        <h2>Gathering and Storing Information</h2>
        <p>
            Spitball may gather and store the following information during the running of the Spitball Service:
        </p>
        <p>
            Information You Provide: During account registration we gather personal information, which may include your name, email, university, and classes. If you sign up using Facebook we gather your Facebook name.
        </p>
        <p>
            Your IP Address: During account registration and/or account login, we gather information that may indicate if your account is real or fraud. As a part of that process, we may save your IP address and compare your country zone with the mobile number you provided.
        </p>
        <p>
        ...
        <p>Personal Information: In the course of using the Spitball Service, we may gather personal information that can be used to contact or identify you. Personal Information is or may be used: (i) to provide and improve our Service, (ii) to administer your use of the Service, (iii) to better understand your needs and interests, (iv) to personalize and improve your experience, and (v) to provide or offer software updates and product announcements. If you no longer wish to receive communications from us, please follow the "unsubscribe" instructions provided in the Spitball email messages.</p>
        <p>Analytics: We gather some information (using third party services) using logging and cookies, which can sometimes be correlated with Personal Information. We use this information for the above purposes and to monitor and analyze use of the Service, for the Service's technical administration, to increase our Service's functionality and user-friendliness, and to verify users have the authorization needed for the Service to process their requests. As of the date this policy went into effect, we use Google Analytics. To learn more about the privacy policy of Google Analytics, click <a target="_blank" href="https://policies.google.com/privacy?hl=en">here</a>.</p>
        <h2>Sharing and Disclosure</h2>
        <p>Your profile page will display your Personal Information and elsewhere on the Service according to the preferences you set in your account. Any information you choose to provide should reflect how much you want others to know about you. Please consider carefully what information you disclose in your profile page and your desired level of anonymity. Through your Spitball account you can review and revise your profile information at any time. Through certain features of the Service, you may also have the ability to make some of your information public. Public information may be broadly and quickly disseminated. Please consider what information you want to make public.</p>
        <p>Service Providers, Business Partners and Others: Spitball may use certain trusted third party companies and individuals to help us provide, analyze, and improve the Service (including but not limited to data storage, maintenance services, database management, web analytics, payment processing, and improvement of the Service's features). These third parties may have access to your information only for purposes of performing these tasks on our behalf and under obligations similar to those in this Privacy Policy.</p>
        <p>Compliance with Laws and Law Enforcement Requests; Protection of Spitball' Rights: We may disclose to parties outside Spitball files stored in your Spitball account and information about you that we gather when we have a good faith belief that disclosure is reasonably necessary to (a) comply with a law, regulation or compulsory legal request; (b) protect the safety of any person from death or serious bodily injury; (c) prevent fraud or abuse of Spitball or its users; or (d) to protect Spitball' property rights. If we provide your Spitball files to a law enforcement agency as set forth above, we will remove Spitball' encryption from the files before providing them to law enforcement. However, Spitball will not be able to decrypt any files that you encrypted prior to storing them on Spitball.</p>
        ...
        <h2>Security</h2>
        <p>The security of your information is important to us. When you enter sensitive information (such as your login and password) we encrypt the transmission of that information using secure socket layer technology (SSL).</p>
        <p>We follow generally accepted standards to protect the information submitted to us, both during transmission and once we receive it. No method of electronic transmission or storage is 100% secure, however. Therefore, we cannot guarantee its absolute security. If you have any questions about security on our website, you can contact us at <a href="mailto:support@spitball.co">support@spitball.co</a></p>
        <h2>Spitball Community</h2>
        <p>Our Service offers publicly accessible community services such as Q&As and comments. You should be aware that any information you provide in these areas may be read, gathered, and used by others who access them. Your posts may remain even after you cancel your account.</p>
        <h2>Our Policy towards Children</h2>
        <p>Our Services are directed to students in higher education and not directed to persons under 17. We do not knowingly gather personally identifiable information from children under 13. If a parent or guardian becomes aware that his or her child has provided us with Personal Information without their consent, he or she should contact us at <a href="mailto:support@spitball.co">support@spitball.co</a>. If we become aware that a child under 13 has provided us with Personal Information, we will take steps to delete such information from our files.</p>
        <h2>Other Sites</h2>
        <p>Spitball contains links to other websites not owned or operated by Spitball. If you click on such a link, you may be taken away from Spitball to an entirely different website. This Policy applies only to Spitball and not to any third-party website that may be accessed through links on Spitball. We encourage you to be aware when we link to other websites and to read the privacy policies of each website.</p>
        <h2>Contacting Us</h2>
        <p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:support@spitball.co">support@spitball.co</a>.</p>
        <h2>Changes to our Privacy Policy</h2>
        <p>This Privacy Policy may change from time to time. If we make a change to this privacy policy that we believe materially changes your rights, we will provide you with notice (for example, by email). And we may provide notice of changes in other circumstances as well. By continuing to use the Service after those changes become effective, you agree to be bound by the revised Privacy Policy.</p>
    </div>
