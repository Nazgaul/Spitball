<template functional v-once>
    <div class="term">
        ...
        <p v-language:inner>privacy_information_you_provide</p>
        ...
        <p v-language:inner>privacy_Compliance_Enforcement_Requests</p>
        <p v-language:inner>privacy_Business_Transfers</p>
        <p v-language:inner>privacy_non_privte_information</p>
        <h2 v-language:inner>privacy_Data_Retention</h2>
