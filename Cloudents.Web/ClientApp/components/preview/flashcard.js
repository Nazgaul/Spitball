...
export default {
    ...
    computed: {
        ...
        beginText() {
            return this.isEnded ? LanguageService.getValueByKey("preview_flashcard_beginText_start_over") : LanguageService.getValueByKey("preview_flashcard_beginText_start")
        },
        isEnded() {
        ...
        currentPinn() {
            return new Set(this.pinnedCards[this.$attrs.id])
        },
        currentCard() {
            if (this.currentIndex > -1 && this.showList && this.currentIndex < this.showList.length) return this.showList[this.currentIndex].data
        },
        showCards() {
            return (this.currentCard && !this.isEnded)
        }
    },
    created() {
    ...
    methods: {
        ...
        handleArrow(event) {
            ...
            else if (this.currentCard && (KeyCode.ARROW_DOWN || KeyCode.ARROW_UP)) {
