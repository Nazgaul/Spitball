...
var Carousel = {
  ...
  methods: {
    ...
    initAutoPlay: function initAutoPlay() {
      ...
      this.timer = new Timer(function () {
        if (_this2.isSliding || _this2.isDragging || _this2.isHover && _this2.config.hoverPause || _this2.isFocus || !_this2.$props.autoPlay) {
    ...
    onDrag: function onDrag(event) {
      if (this.isSliding || !this.isMousePressed) {
        return;
      }
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      _this8.slideTo(_this8.config.initialSlide || 0);
