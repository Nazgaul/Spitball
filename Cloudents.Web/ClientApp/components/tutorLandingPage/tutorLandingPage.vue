<template>
    <div  class="tutor-landing-page-container">
        <v-layout class="pt-2 pt-sm-1 pb-sm-4 tutor-landing-page-header"  px-6 align-center justify-center column>
            ...
            <!-- <v-flex class="pb-6">
                <h3><span v-t="'tutorListLanding_rates'"></span>&nbsp; <v-icon v-for="n in 5" :key="n" class="tutor-landing-page-star">sbf-star-rating-full</v-icon>&nbsp; <span v-t="'tutorListLanding_reviews'"></span></h3> -->
        ...
        <!-- <v-layout align-center py-12 justify-space-around class="tutor-landing-status-row">
            <span class="hidden-xs-only"><span v-t="'tutorListLanding_rates'"></span>&nbsp; <v-icon v-for="n in 5" :key="n" class="tutor-landing-page-star">sbf-star-rating-full</v-icon>&nbsp; <span v-t="'tutorListLanding_reviews'"></span></span> -->
        <v-layout align-center py-12 justify-space-around class="tutor-landing-status-row">
