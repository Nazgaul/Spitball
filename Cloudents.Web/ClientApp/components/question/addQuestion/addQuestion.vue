    ...
    <transition name="fade">
        <div class="add-question-container">
            ...
            <div class="question-textarea-container" :class="{'textArea-error': hasTextAreaError}">
              ...
              <file-upload
                    ...
                    <div class="question-thumbnails-part"
                        ...
                        <div v-for="thumbnailBox in [0,1,2,3]"
                             :key="thumbnailBox"
                             class="question-attachment-box horizontal-border vertical-border">
                            <div @click="removeImage(uploadProp.populatedThumnbailBox['box_'+thumbnailBox])"
            ...
            <div class="question-component-container">
                ...
                <component :is="`question-${currentComponentselected.name}`"
                           :callback="currentComponentselected.callback"></component>
            </div>
            <div class="question-add-button-container">
                <v-btn :loading="addQuestionButtonLoading" class="question-add-button" @click="addQuestion()"><span
                        v-language:inner>addQuestion_add_button</span></v-btn>
            </div>
        </div>
    </transition>
</template>
