<template>
    <div class="answer-question" v-if="questionData">
        ...
        <v-dialog v-model="showDialog" :type="dialogType" :fullscreen="$vuetify.breakpoint.xs" max-width="720px"  scrollable content-class="question-suggest">

            <question-suggest-pop-up v-if="" :user="questionData.user" :cardList="cardList.nextQuestions"></question-suggest-pop-up>
        </v-dialog>
    </div>
</template>
