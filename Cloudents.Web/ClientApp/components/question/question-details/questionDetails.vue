    ...
    <div class="answer-question" v-if="questionData">
        ...
        <div class="pt-4 question-wrap" v-if="!$vuetify.breakpoint.smAndDown"
            ...
            <v-flex xs12 class="breadcrumbs">
                <a style="cursor:pointer;" @click="resetSearch()" v-t="questionDetails_Ask_question"></a>
                <span class="question-category"> <span v-t="questionDetails_question_dash"></span>{{questionData.subject}}</span>
            </v-flex>
            <v-layout>
