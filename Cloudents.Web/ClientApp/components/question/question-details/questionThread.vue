<template functional>
    <v-layout column v-if="props.questionData">
        <question-card :cardData="props.questionData" class="user-question mb-1" detailed-view></question-card>
        <slot name="answer-form"></slot>
        <div>
            <h3 class="Answers ma-2 " v-if="props.questionData.answers.length">Answers</h3>
