    ...
    <v-card :style="isTransparent ? 'background: transparent;' : 'background-color: #fff;' ">
        <div class="dialog-wrapp referral-container">
            ...
            <!--<div class="share-icon-container">-->
                <!--<span @click="shareOnSocialMedia(socialMedias.whatsApp)">-->
                    <!--<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">-->
                        <!--<g fill="none" fill-rule="nonzero">-->
                            <!--<path fill="#4CAF50"-->
                                  <!--d="M16.004 0h-.008C7.174 0 0 7.176 0 16c0 3.5 1.128 6.744 3.046 9.378l-1.994 5.944 6.15-1.966A15.862 15.862 0 0 0 16.004 32C24.826 32 32 24.822 32 16S24.826 0 16.004 0z"/>-->
                            <!--<path fill="#FAFAFA"-->
                ...
                <!--</span>-->
                <!--<span>-->
                    <!--<svg @click="shareOnSocialMedia(socialMedias.facebook)" xmlns="http://www.w3.org/2000/svg"-->
                         <!--width="32" height="32" viewBox="0 0 32 32">-->
                        <!--<g fill="none" fill-rule="nonzero">-->
                            <!--<circle cx="15.886" cy="15.886" r="15.886" fill="#3B5998"/>-->
                            <!--<path fill="#FFF"-->
                                  <!--d="M19.88 16.508h-2.835v10.385H12.75V16.508h-2.042v-3.65h2.042v-2.361c0-1.69.803-4.334 4.333-4.334l3.182.013V9.72h-2.308c-.38 0-.911.19-.911.995v2.148h3.21l-.376 3.646z"/>-->
                        <!--</g>-->
                    <!--</svg>-->
                <!--</span>-->
                <!--<span @click="shareOnSocialMedia(socialMedias.linkedin)">-->
                ...
                <!--<span @click="shareOnSocialMedia(socialMedias.gmail)">-->
                    <!--<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">-->
                        <!--<g fill="none" fill-rule="nonzero">-->
                            ...
                            <!--<path fill="#EA0A0A"-->
                                  <!--d="M25.988 9.217H5.972l7.252 7.55 2.092 2.119c-1.138-.26-1.209-.423-1.713-.835-.265-.216-.776-.803-1.553-1.596L5.514 9.78v12.427l.516.516-.058.06 9.195 9.196c.276.014.554.021.833.021 8.837 0 16-7.163 16-16 0-.265-.007-.53-.02-.791l-5.992-5.992z"/>-->
                            <!--<g fill="#FFF">-->
