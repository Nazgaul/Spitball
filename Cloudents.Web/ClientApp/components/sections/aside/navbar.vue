    ...
    <aside>
        ...
        <!--<ul>
            <li @click="changeSection('ask')" v-class="{'selected':(sec=='ask')}">
                <div class="ask">
                <img src="../header/Images/normal-logo.svg" />
                    <svg v-svg="icons-ask" class="icon-ask"></svg>
                    <svg class="icon icon-ask">
                        <use xlink:href="../Images/icons.svg#icon-ask"></use>
                    </svg>
                </div><span>ask</span>
            </li>
            <li ng-click="ctrl.changeSection('note')" ng-class="{'selected':(ctrl.sec=='note')}">
                <div class="note">
                    <svg class="icon icon-note">                      
                        <use xlink:href="../Images/icons.svg#icon-note"></use>
                    </svg>
                </div><span>notes</span>
            </li>
