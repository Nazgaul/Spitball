        ...
        <div class="content-container">
            ...
            <div class="filter-wrap px-3" v-if="filterOptions && filterOptions.length">
                ...
                <div class="filter-sections">
                    <div class="filter-section" v-for="singleFilter in filterOptions" :key="singleFilter.modelId" :value="true">
                        ...
                        <div class="filter-list">
                            ...
                            <v-btn-toggle  v-model="filters[singleFilter.modelId]" multiple>
