     ...
     <template v-if="getProfile.user.isTutor">
      <div class="profileUserStickyMobile_user">
         ...
         <div class="profileUserStickyMobile_user_info">
               ...
               <button :class="{'isMyProfileCoupon':isMyProfile}" class="profileUserStickyMobile_coupon" @click="$store.commit('setComponent', 'register')" v-language:inner="'coupon_apply_coupon'"/>
         </div>
      </div>
