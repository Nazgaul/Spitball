<template>
   <div class="profileEarnMoney">
      <div class="profileEarnMoney_wrapper">
         ...
         <v-btn class="profileEarnMoney_action white--text" depressed rounded color="#4452fc" v-openDialog="'upload'">
...
.profileEarnMoney{
   ...
   .profileEarnMoney_wrapper{
      max-width: 490px;
      margin: 0 auto;
      .profileEarnMoney_title{
         font-weight: bold;
         font-size: 21px;
         padding-bottom: 8px;
      }
      .profileEarnMoney_desc{
         font-size: 16px;
         padding-bottom: 18px;
      }
      .profileEarnMoney_action{
         text-transform: capitalize;
         max-width: 250px;
         width: 100%;
         height: 38px;
         margin: 0;
         .profileEarnMoney_action_txt{
            font-size: 16px;
            font-weight: 600;
         }
      }
