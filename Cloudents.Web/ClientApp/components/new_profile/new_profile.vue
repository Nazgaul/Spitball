<template>
    <v-container class="profile-page-container" wrap>
            ...
            <v-layout column>
                ...
                <v-flex class="web-content">
                    ...
                    <div class="empty-state"
                        ...
                        <router-link class="ask-question" :to="{name: emptyStateData.btnUrl}">{{emptyStateData.btnText}}
                        </router-link>
                    </div>
                    ...
                    <scroll-list v-if="activeTab === 4" :scrollFunc="loadPurchasedDocuments"
                                 :isLoading="purchasedDocuments.isLoading" :isComplete="purchasedDocuments.isComplete">
                        <router-link :to="{name:'document',params:{id:document.id}}"
