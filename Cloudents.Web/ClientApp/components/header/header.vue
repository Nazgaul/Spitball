                ...
                <v-layout row>
                    ...
                    <v-toolbar-items>
                        <form v-if="$vuetify.breakpoint.mdAndUp" @submit.prevent="submit" ref="myForm">
                            <v-text-field type="search" light solo class="search-b" ref="qFilter" :placeholder="placeholders[currentSelection]" v-model="qFilter" prepend-icon="sbf-search" :append-icon="voiceAppend" :append-icon-cb="$_voiceDetection"></v-text-field>
                        </form>
