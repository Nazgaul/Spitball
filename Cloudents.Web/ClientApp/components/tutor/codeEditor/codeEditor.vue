...
<script>
    ...
    export default {
        ...
        created(){
            //load vue recaptha
            this.$loadScript(`https://www.gstatic.com/firebasejs/5.8.5/firebase.js`).then(
                (data) => {
                    // Initialize Firebase
                    var config = {
                    ...
                    this.$loadScript(`https://cdnjs.cloudflare.com/ajax/libs/ace/1.2.5/ace.js`).then(
                        (data) => {
                            // Create CodeMirror (with lineWrapping on).
                            // var codeMirror = CodeMirror(document.getElementById('firepad'), { lineWrapping: true });
                            this.$loadScript(`https://cdn.firebase.com/libs/firepad/1.4.0/firepad.min.js`).then(
                                () => {
