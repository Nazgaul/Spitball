...
const baseURL = "https://api.spitball.co/api/";
...
const searchFunctions = {
    getDocument: (params) => axios.get("search/documents", {baseURL, params, transformResponse: transferResultNote }),
    ...
    getFood: (params) => axios.get("places", {baseURL, params:transformLocation(params), transformResponse: transferFood })
};
