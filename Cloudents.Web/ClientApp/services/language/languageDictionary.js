export const dictionary = {
    ...
    login_silogin_or_use_your_emailgn_up_with_google:"Sign Up with Google",
    login_or_use_your_email:"or use your email",
    login_continue:"Continue",
    login_By_joining_i_agree_to_spitball:"By joining, I agree to Spitball",
    login_terms_of_services:"Terms of Services",
    login_and:"and",
    login_privacy_policy:"Privacy Policy",
    login_do_you_already_have_an_account:"Do you already have an account?",
    login_sign_in:"Sign in",
    login_get_started:"Get started",
    login_login:"Login",
    login_need_an_account:"Need an account?",
    login_sign_up:"Sign up",
    login_check_your_email_to_activate_your_account:"Check your email to activate your account",
    login_an_activation_email_has_been_sent_to:"An activation email has been sent to",
    login_you_will_not_be_able_to_log_into_spitball_co_until_you_activate_your_account:"You will not be able to log into Spitball.co until you activate your account.",
    login_didnt_get_an_emaill:"Didn’t get an email?",
    ...
    login_we_sent_the_code_to_you_by_sms_to:"We sent the code to you by SMS to",
    login_we_sent_a_confirmation_code:"We sent a confirmation code",
    login_to_your_mobile_phone:"to your mobile phone.",
    login_didnt_get_an_sms:"Didn't get an sms?",
    ...
    login_you_didnt_complete_the_registration_process:"You didn't complete the registration process",
    login_your_confirmation_link_has_expired:"Your confirmation link has expired",
    login_register:"Register",
    login_are_you_sure_you_want_to_exit:"Are you sure you want to exit?",
    login_exiting_from_this_process_will_delete_all_your_progress_and_information:"Exiting from this process will delete all your progress and information",
    login_Change:"Change",
