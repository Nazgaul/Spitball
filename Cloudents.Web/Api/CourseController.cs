...
namespace Cloudents.Web.Api
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        [HttpPost("assign")]
        public async Task<IActionResult> AssignCoursesAsync([FromBody] AssignCoursesRequest model, CancellationToken token)
        {
            var userId = _userManager.GetLongUserId(User);
            var command = new AssignCourseToUserCommand(model.Courses.Select(s=>s.Name), userId);
