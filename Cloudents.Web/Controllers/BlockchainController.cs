...
//       // private readonly ICrowdsaleService _CrowdsaleProvider;
...
//        public BlockchainController(ICrowdsaleService CrowdsaleProvider)
//        {
            
//            _CrowdsaleProvider = CrowdsaleProvider;
//        }
...
//        //    var transactionReceipt = await _CrowdsaleProvider.TransferMoneyAsync(from, to, model.Amount, token);
...
//            return _CrowdsaleProvider.GetBalanceAsync(@from, token);
//        }

//        [HttpPost]
//        public string CreateAccount()
//        {
//            var account = _CrowdsaleProvider.CreateAccount();
...
//        {
//            var result = await _CrowdsaleProvider.SetInitialBalanceAsync(address, token).ConfigureAwait(false);
//            return result;
//        }
...
//        {
//            string result = await _CrowdsaleProvider.BuyTokens(senderPK, amount, token);
//            return result;
//        }
//    }
}
