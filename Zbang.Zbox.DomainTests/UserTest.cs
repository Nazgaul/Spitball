...
namespace Zbang.Zbox.DomainTests
{
    ...
    public class UserTest
    {
        ...
        public void Setup()
        {
            m_SomeUser = new User("some email", " some small image", "some largeImage", "some first name", "some middle name", "some last name", false, "en-US", false);
        }
        ...
        {
            long someBoxId = 1;
            var someOtherUser = new User("some email2", " some small image2", "some largeImage2", "some first name2", "some middle name2", "some last nam2e",  false, "en-US", false);
