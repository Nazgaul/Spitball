...
{
    class BoxSearchProviderOld : IBoxReadSearchProviderOld, IBoxWriteSearchProviderOld
    {
         private readonly string m_IndexName = "box";
        private bool m_CheckIndexExists;
        private readonly ISearchConnection m_Connection;

        public BoxSearchProviderOld(ISearchConnection connection)
        {
