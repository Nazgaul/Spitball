        ...
        private static IEnumerable<KeyValuePair<string, IEnumerable<JsFileWithCdn>>> RegisterJs()
        {
            var jsDictionary = new Dictionary<string, IEnumerable<JsFileWithCdn>>
            {
                ...
                [
                    "jsHomePage"] = new[]
                    {
                        new JsFileWithCdn("~/scripts/jquery-2.2.4.js",
                ...
                [
                    "jsSite4"] = new[]
                    {
                       ...
                       // new JsFileWithCdn("~/scripts/angular-dfp.js"),
                        ...
                        new JsFileWithCdn("~/js/components/user/gamification.controller.js"),
                        new JsFileWithCdn("~/js/components/user/classmates.controller.js"),
                        new JsFileWithCdn("~/js/components/user/items.controller.js"),
                        new JsFileWithCdn("~/js/components/user/posts.controller.js"),
                        new JsFileWithCdn("~/js/components/user/quizzes.controller.js"),
                    ...
                    new JsFileWithCdn("~/js/components/box/box.module.js"),
                     ...
                     new JsFileWithCdn("~/js/components/box/leaderboard.controller.js"),
                        ...
                        new JsFileWithCdn("~/js/components/library/classChooseUnfollowDialog.controller.js"),
                        ...
                        new JsFileWithCdn("~/js/components/item/likeToasterController.js"),
                        ...
                        new JsFileWithCdn("~/js/components/flashcard/flashcardCreate.controller.js"),
                        new JsFileWithCdn("~/js/components/flashcard/flashcard.service.js"),
                        ...
                        new JsFileWithCdn("~/js/shared/multiswitchWhen.directive.js"),
