...
.factory('taToolFunctions', ['$window', 'taTranslations', function ($window, taTranslations) {
    return {
        imgOnSelectAction: function (event, $element, editorScope) {
            ...
            halfButton.on('click', function (e) {
                e.preventDefault();
                $element.css({
                    'width': '50%',
                    'height': ''
            ...
            quartButton.on('click', function (e) {
                e.preventDefault();
                $element.css({
                    'width': '25%',
                    'height': ''
            ...
            floatRight.on('click', function (e) {
                e.preventDefault();
                // webkit
        ...
        aOnSelectAction: function (event, $element, editorScope) {
            ...
            reLinkButton.on('click', function (e) {
                e.preventDefault();
...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', 'taToolFunctions', '$sanitize', 'taOptions', function (taRegisterTool, $window, taTranslations, taSelection, taToolFunctions, $sanitize, taOptions) {
    ...
    var gv = {}; $sanitize('', gv);
    function createSvgButtonDisplay(svgNamge) {
        return '<button type="button" class="btn btn-default">' + createSvg(svgNamge) + '</button>';
    }

    function createSvg(svgHash) {
        return '<svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/images/textEditor.svg?26.0.0#' + svgHash + '"></use></svg>';
    }
    ...
    //});
    taRegisterTool('ul', {
        display: createSvgButtonDisplay('bullets'),
    ...
    taRegisterTool('ol', {
        display: createSvgButtonDisplay('numbered'),
    ...
    taRegisterTool('redo', {
        ...
        display: createSvgButtonDisplay('redo'),
    ...
    taRegisterTool('bold', {
        ...
        display: createSvgButtonDisplay('bold'),
    ...
    taRegisterTool('justifyLeft', {
        ...
        display: createSvgButtonDisplay('alignLeft'),
    ...
    taRegisterTool('justifyRight', {
        ...
        display: createSvgButtonDisplay('alignRight'),
    ...
    taRegisterTool('justifyCenter', {
        ...
        display: createSvgButtonDisplay('alignCenter'),
    ...
    taRegisterTool('italics', {
        display: createSvgButtonDisplay('italic'),
    ...
    taRegisterTool('underline', {
        display: createSvgButtonDisplay('underline'),
    ...
    taRegisterTool('fontUp', {
        display: createSvgButtonDisplay('textIncrease'),
        action: function () {
            if (fontSize < 7) {
                fontSize++;
            }
        ...
        tooltiptext: taTranslations.fontUp.tooltip

    });

    taRegisterTool('fontDown', {
        display: createSvgButtonDisplay('textDecrease'),
        action: function () {
            if (fontSize > 1) {
                fontSize--;
            }
        ...
        tooltiptext: taTranslations.fontDown.tooltip
    });
    ...
    taRegisterTool('insertImage', {
        ...
        action: function (imageLink) {
            ...
            //}
            if (this.$editor() && angular.isString(imageLink)) {
