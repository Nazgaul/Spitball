...
module app {
    ...
    export interface IAjaxService2 {
        get(url: string, data?: Object, category?: cacheKeys, cancelCategory?: string): angular.IPromise<Object>;
        post(url: string, data: Object, category?: cacheKeys | Array<cacheKeys>): angular.IPromise<Object>;
