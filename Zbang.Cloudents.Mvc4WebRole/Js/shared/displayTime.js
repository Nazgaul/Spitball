(function () {
    angular.module('displayTime').factory('displayTimeService', displayTimeServiceF);
    displayTimeServiceF.$inject = ['$interval', '$rootScope'];
    function displayTimeServiceF($interval, $rootScope) {
    ...
    angular.module('displayTime').directive('displayTime', displayTime);
    displayTime.$inject = ['$log', '$filter', 'displayTimeService'];
    function displayTime($log, $filter, displayTimeService) {
        return {
            restrict: "A",
    ...
    angular.module('displayTime').filter('displayTimeFilter', displayTimeFilter);
            ...
            switch (dateDifference) {
                ...
                default:
                    ...
                    if (dateMonth < todayMonth) {
                        return date.getDate() + ' ' + $locale.DATETIME_FORMATS.SHORTMONTH[dateMonth - 1];
                    } else if (dateMonth > todayMonth) {
                        return date.getDate() + ' ' + $locale.DATETIME_FORMATS.SHORTMONTH[dateMonth - 1] + ', ' + date.getFullYear();
