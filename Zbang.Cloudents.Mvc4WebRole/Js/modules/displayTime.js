angular.module('DisplayTime', []).
    factory('displayTimeService', ['$timeout', '$filter','$rootScope',
        function ($timeout, $filter,$rootScope) {
            $timeout(updateElements, 60000);
    ...
    ['$log', 'displayTimeService','$rootScope',
    function ($log, displayTimeService, $rootScope) {
        return {
            restrict: "A",
            link: function (scope, elem, attrs) {
                ...
                scope.$on('updateTime', function () {
                    elem[0].textContent = displayTimeService.parse(attrs.displayTime);
                });
