...
+function (angular, undefined) {
    ...
    function directive($window, $document, $timeout, $q) {
        ...
        function linkFn(scope, element) {
            ...
            var promise = null;
            var scrollPromise = null;//A promise for waiting to scroll to be completed
            ...
            function $handle(evt) {
                ...
                scrollPromise = $timeout(function () {//Timeout giviang the scroll chance to be completed
                    ...
                    if (scroll <= _last_scroll) { //No need to ever load more on a reverse scroll
                        return;
                    }
