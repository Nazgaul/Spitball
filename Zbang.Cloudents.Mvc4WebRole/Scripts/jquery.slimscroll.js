        ...
        slimScroll: function (options) {
            ...
            this.each(function () {
                ...
                if (me.parent().hasClass(o.wrapperClass)) {
                    ...
                    if ($.isPlainObject(options)) {
                        ...
                        if ('scrollTo' in options) {
                            ...
                            rail.remove();
                            me.unwrap();
                            me.css({ overflow: '', width: '', height: '' }); //Ram : touch in here
                            return;
                        }
                ...
                function _onWheel(e) {
                    ...
                    if (e.detail) { delta = e.detail / 16; } //fix value in here
                ...
                function scrollContent(y, isWheel, isJump) {
                    ...
                    percentScroll = parseInt(bar.css('top'),10) / (me.outerHeight() - bar.outerHeight());
