...
//        //{
//        //    return await _client.CreateDocumentAsync(UriFactory.CreateDocumentCollectionUri(DatabaseId, GetCollectionId()), item);
//        //}

//        //public async Task<Document> UpdateItemAsync(string id, T item)
//        //{
//        //    return await _client.ReplaceDocumentAsync(UriFactory.CreateDocumentUri(DatabaseId, GetCollectionId(), id), item);
//        //}
...
//            try
//            {
//                Document document = await _client.ReadDocumentAsync(UriFactory.CreateDocumentUri(DocumentDbRepositoryUnitOfWork.DatabaseId, GetCollectionId(), id));
