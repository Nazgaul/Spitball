...
namespace Cloudents.Infrastructure.Database.Query
{
    ...
    public class QuestionsQueryHandler : IQueryHandler<QuestionsByIdsQuery, IList<QuestionDto>>
    {
        ...
        public async Task<IList<QuestionDto>> GetAsync(QuestionsByIdsQuery query, CancellationToken token)
        {
