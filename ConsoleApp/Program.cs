...
namespace ConsoleApp
{
    static class Program
    {
        ...
        static async Task Main()
        {
            ...
            await CreateAuditOnExistsingData();
        ...
        private static async Task CreateAuditOnExistsingData()
        {
        ...
        private static async Task CreateUserAudit(ILifetimeScope container)
        {
        ...
        private static async Task CreateQuestionAudit(ILifetimeScope container)
        {
            var t = container.Resolve<IQuestionRepository>();
        ...
        private static async Task CreateAnswerAudit(ILifetimeScope container)
        {
            var t = container.Resolve<IQuestionRepository>();
            var blob = container.Resolve<IBlobProvider<QuestionAnswerContainer>>();
        ...
        private static async Task MarkAnswerAudit(ILifetimeScope container)
        {
            var t = container.Resolve<IQuestionRepository>();
            var blob = container.Resolve<IBlobProvider<QuestionAnswerContainer>>();
            var questions = await t.GetAllQuestionsAsync();
        ...
        private static async Task CreateAudit(ICommand message, ILifetimeScope container)
        {
