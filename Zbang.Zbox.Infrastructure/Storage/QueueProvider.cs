...
namespace Zbang.Zbox.Infrastructure.Storage
{
    public class QueueProvider : IQueueProvider
    {
        ...
        internal const string DownloadContentFromUrl = "downloadcontentfromurl";
        internal const string DownloadContentFromUrlPahse2 = "downloadcontentfromurlphase2";
        ...
        {
            return GetQueue(DownloadContentFromUrl.ToLower());
        }
        ...
        {
            return GetQueue(UpdateDomainQueueName.ToLower());
        }
