...
namespace Cloudents.Core.Storage
{
    ...
    public sealed class StorageContainer : IEquatable<StorageContainer>
    {
        ...
        public static readonly StorageContainer StudyRoom = new StorageContainer("spitball-files","study-room");
        ...
        public static readonly StorageContainer Admin = new StorageContainer("spitball-admin", "videos");
