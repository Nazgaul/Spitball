...
[![Nuget](https://img.shields.io/nuget/v/SoftwareAteliers.Cloudents.VueCli.svg?style=flat&color=2196f3)](https://www.nuget.org/packages/aspnetcore-vuejs/)
...
* Install the template from NuGet repository: `dotnet new -i SoftwareAteliers.Cloudents.VueCli`
