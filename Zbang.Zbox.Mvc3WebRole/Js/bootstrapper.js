(function (mmc, $) {
    ...
    mmc.confirm = function (msg) {
        ...
        ////$('footer').after('<div class="popupWrppr confirm txtshd1" id="ConfirmPop"><header class="popupHeader popupGradient"></header><div class="message"></div><input type="submit" class="btn1 next" /><input type="button" class="btn2 cancel" value="Cancel" /><button class="closeDialog shareSprite"></button></div>');
    ...
    function registerSubscribePopUp() {
        if (!mmc.register) {
            ...
            $('.boxUploadbtn,textarea,#edit,#delete').click(function (e) {
                registerPopUp(e);
            });
    ...
    function registerDropDowns() {
        if (mmc.register) {
            $('.userDrpArrow').click(function (e) {
                ...
                e.stopPropagation();
                $('ul.userMenu').slideDown(150);
            });
            //$('.boxUploadbtn').click(function (e) {
            //    e.stopPropagation();
            //    $('ul.uploadMenu').slideDown(150);
            //});
            $('body').click(function () {
                $('ul.userMenu').slideUp(150);
                $('ul.uploadMenu').slideUp(150);
            });
        }
    }
    ...
    mmc.modal = function (jsExtra, popupElem, css) {
        ...
        modal.click(popupElem, function () {
