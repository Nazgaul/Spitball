    ...
    $.fn.addTriggersToJqueryValidate = function () {
        ...
        return this.each(function () {
            ...
            validator.form = function () {
                ...
                $(form).trigger((result == true || result == null) ? 'formValidationSuccess' : 'formValidationError', form);
            ...
            validator.element = function (element) {
                ...
                $(element).trigger((result == true || result == null) ? 'elementValidationSuccess' : 'elementValidationError', element);
